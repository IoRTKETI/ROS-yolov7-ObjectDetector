...
class TRT_engine():
    ...
    def predict(self,img,threshold):
        ...
        boxes = self.bindings['det_boxes'].data  # 4
        
        scores = self.bindings['det_scores'].data  # 1
        classes = self.bindings['det_classes'].data  # 1
        boxes = boxes[0, :nums[0][0]]
        scores = scores[0, :nums[0][0]]
        classes = classes[0, :nums[0][0]]
        
        return boxes, scores, classes, self.r, (self.dw, self.dh)
    '''
    ...
    def predict(self,img,threshold):
        ...
        for i in range(num):
            ...
            new_bboxes.append([xmin,ymin,xmax,ymax,scores[i],classes[i]])
        return new_bboxes